...
export default class BookRepository {
    ...
    try {
        ...
        // If target entity not found, throw error
        if (!targetEntity) {
            throw new Error(`The specified target entity (${target === 'Book' ? 'Book' : 'Author'}) was not found.`);
        }
        ...
        // Add the review reference to the target entity
        if (target === 'Book') {
